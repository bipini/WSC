...
function ValidateFileUpload() {
    var fuData = document.getElementById('filecontent');
			...
			<fieldset>
				<table class="form-register">					
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="userName" id="userName" required="true" placeholder="User Name" maxlength="40"
					...
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="firstName" required="true" maxlength="50"
					...
					<tr>
						...
						<td>
							...
							maxlength="50" value="<%=userDto.getLastName()%>"/>
					...
					<tr>
						...
						<td>
							...
							maxlength="14" value="<%=userDto.getPhone()%>"/>
					...
					<tr>
						...
						<td>
							...
							maxlength="6" value="<%=userDto.getPincode()%>" />
            ...
            <table border="0">
                <tr>
                    <td>Upload Your Photo:
                    	...
                    	<img src="<%=photo%>" alt="${userSession.userName}" width="50%" height="30%" />
                    	<%} %>
                    </td>
                    <td><input type="file" name="filecontent" id="filecontent" size="50" /></td>
                </tr>                
                <tr>
                    <td colspan="2" align="center"><input type="submit" value="Upload" id="Upload" onclick="ValidateFileUpload()"/></td>
                </tr>
            </table>
        </form>
        </div>
